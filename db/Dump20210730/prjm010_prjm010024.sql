...
--
-- Table structure for table `prjm010024`
--

DROP TABLE IF EXISTS `prjm010024`;
...
CREATE TABLE `prjm010024` (
  ...
  KEY `fk_prjm010024_PRJM010032_idx` (`location_id`),
  KEY `fk_prjm010024_PRJM010029_idx` (`local_id`),
  CONSTRAINT `fk_prjm010024_PRJM010001` FOREIGN KEY (`person_id`) REFERENCES `prjm010001` (`person_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_prjm010024_PRJM010029` FOREIGN KEY (`local_id`) REFERENCES `prjm010029` (`local_id`),
  CONSTRAINT `fk_prjm010024_PRJM010032` FOREIGN KEY (`location_id`) REFERENCES `prjm010032` (`location_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `prjm010024`
--
...
-- Dump completed on 2021-07-30 17:42:26
