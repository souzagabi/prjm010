...
BEGIN
    ...
    INSERT INTO PRJM010017 
		(person_id,name_person,daydate,dayhour,location_id,local_id,nobreakmodel,resulttest,observation,serialnumber)
		VALUES (par_person_id,par_name_person,par_daydate,par_dayhour,par_location_id,par_local_id,par_nobreakmodel,par_resulttest,par_observation,par_serialnumber);
...
BEGIN
    ...
    IF LOC IS NULL THEN
		INSERT INTO PRJM010020
			( person_id, daydate,serialnumber , location_id,local_id, nextmanager)
			VALUES( par_person_id, par_daydate,par_serialnumber , par_location_id,par_local_id, par_nextmanager);
...
BEGIN
    ...
    INSERT INTO PRJM010015
		( person_id, daydate, dayhour, name_person, material, location_id,local_id, warehouse)
		VALUES( par_person_id, par_daydate, par_dayhour, par_name_person, par_material, par_location_id, par_local_id, par_warehouse);
...
BEGIN
    ...
    IF par_person_id IS NULL THEN
		 CALL prc_person_save(par_name_person,par_phonenumber,par_photo,par_rg_person,par_cpf_person,par_email,par_classification,par_daydate,'0','','',0);
...
-- Dump completed on 2021-07-30 17:42:31
