...
BEGIN
	...
	SELECT "SUCCESS: Dados atualizados com sucesso!! " ASMESSAGE;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    SELECT "SUCESS: Registro salvo com sucesso!!" AS MESSAGE;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	BEGIN
        ...
        IF ERR IS NOT NULL THEN
			SET  MESSAGE = concat('ERROR: Erro ao atualizar registro na tabela PRJM010014. : Erro ', ERRNUMBER,' : ', ERR);
            SELECT MESSAGE;
        END IF;
	END;
...
-- Dump completed on 2021-08-13 14:57:19
