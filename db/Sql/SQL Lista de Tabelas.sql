...
CREATE TABLE `prjm010022` (
  ...
  `qtdeout` decimal(10,2) DEFAULT NULL,
  `singout` varchar(100) DEFAULT NULL,
  `datein` date DEFAULT NULL,
  `qtdein` decimal(10,2) DEFAULT NULL,
  `singin` varchar(100) DEFAULT NULL,
  `user_id_deleted` int DEFAULT NULL,
  `dt_deleted` timestamp NULL DEFAULT NULL,
  `situation` char(1) DEFAULT '0',
  `dtregister` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  KEY `FK_prjm010022_PRJM010013_idx` (`user_id`),
  CONSTRAINT `fk_prjm010022_PRJM010001` FOREIGN KEY (`person_id`) REFERENCES `prjm010001` (`person_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_prjm010022_PRJM010013` FOREIGN KEY (`user_id`) REFERENCES `prjm010013` (`user_id`) ON DELETE CASCADE
...
CREATE TABLE `prjm010023` (
  ...
  KEY `FK_prjm010023_PRJM010013_idx` (`user_id`),
  CONSTRAINT `fk_prjm010023_PRJM010001` FOREIGN KEY (`person_id`) REFERENCES `prjm010001` (`person_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_prjm010023_PRJM010013` FOREIGN KEY (`user_id`) REFERENCES `prjm010013` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb3;
CREATE TABLE `prjm010024` (
  ...
  KEY `FK_prjm010024PRJM010013_idx` (`user_id`),
  CONSTRAINT `fk_prjm010024_PRJM010001` FOREIGN KEY (`person_id`) REFERENCES `prjm010001` (`person_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_prjm010024_PRJM010013` FOREIGN KEY (`user_id`) REFERENCES `prjm010013` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `prjm010026` (
  ...
  KEY `FK_prjm010026_PRJM010013_idx` (`user_id`),
  CONSTRAINT `fk_prjm010026_PRJM010001` FOREIGN KEY (`person_id`) REFERENCES `prjm010001` (`person_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_prjm010026_PRJM010013` FOREIGN KEY (`user_id`) REFERENCES `prjm010013` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
