  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-footer"<?php if( $airconditioning["MESSAGE"] == 'VAZIO' ){ ?>hidden<?php } ?>>
          <a href="/airconditioning?limit=10" class="btn btn-warning">Voltar</a>
        </div>
        <div class="box box-success">
          <!-- form start -->
          <form role="form" action="/airconditioning/<?php if( $airconditioning["MESSAGE"] == 'VAZIO' ){ ?><?php echo htmlspecialchars( $airconditioning["airconditioning_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>" method="post" enctype="multipart/form-data">
          
            <div class="box-body" <?php if( $airconditioning["MESSAGE"] != 'VAZIO' ){ ?>hidden<?php } ?>>
              <div class="col col-md-2">
                <div class="form-group">
                    ...
                    <select class="form-control" name="location_id" id="location_id" required>
                      ...
                      <option value="<?php echo htmlspecialchars( $value1["location_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" <?php if( $airconditioning["MESSAGE"] == 'VAZIO' ){ ?><?php if( $value1["location_id"] == $airconditioning["location_id"] ){ ?>selected<?php } ?><?php } ?> ><?php echo htmlspecialchars( $value1["deslocation"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                      <?php } ?>
                    </select>
                </div>
              </div>
              <div class="col col-md-3">
                  <div class="form-group">
                      ...
                      <select class="form-control" name="local_id" id="local_id" required>
                        ...
                        <option value="<?php echo htmlspecialchars( $value1["local_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" <?php if( $airconditioning["MESSAGE"] == 'VAZIO' ){ ?><?php if( $value1["local_id"] == $airconditioning["local_id"] ){ ?>selected<?php } ?><?php } ?> ><?php echo htmlspecialchars( $value1["deslocal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                        <?php } ?>
                      </select>
                  </div>
              </div>
