<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/airconditioning?pg=1">Ar Condicionado</a></li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="row">
            <div class="col col-md-4">
              <form action="/airconditioning/create" method="get">
                <input type="submit" name="btnairconditioning" class="btn btn-success" value="Cadastrar Ar Condicionado">
                <input type="text" name="airconditioning" value="airconditioning" hidden>
              </form>
            </div>
            <form action="/airconditioning" method="get" <?php if( !$airconditionings ){ ?>hidden<?php } ?>>
              ...
              <div class="col col-md-2"><label for="brand">Marca</label><input type="text" name="brand" id="brand" class="form-control"></div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="/historicA?airconditioning_id=<?php echo htmlspecialchars( $value1["airconditioning_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>_<?php echo htmlspecialchars( $value1["serialnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>_<?php echo htmlspecialchars( $value1["brand"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-success btn-xs" title="Cadastrar Histórico"><i class="fa fa-save"></i></a>
