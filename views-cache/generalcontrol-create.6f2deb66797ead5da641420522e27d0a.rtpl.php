                        ...
                        <div class="box-body">
                            ...
                            <div class="col col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="dthydraulic" name="dthydraulic" onChange="replaceSlash(dthydraulic)" >
                                </div>
                            </div>
                            <div class="col col-md-2">
                                <div class="form-group">
                                    <label for="dteletric">Elétrica</label>
                                    <input type="text" class="form-control" id="dteletric" name="dteletric" onChange="replaceSlash(dteletric)" >
                                </div>
                            </div>
                            <div class="col col-md-2">
                                <div class="form-group">
                                    <label for="dtbuilding">Predial</label>
                                    <input type="text" class="form-control" id="dtbuilding" name="dtbuilding" onChange="replaceSlash(dtbuilding)" >
                                </div>
                            </div>
                        </div>
