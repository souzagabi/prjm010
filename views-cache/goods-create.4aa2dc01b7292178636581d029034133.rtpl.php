          ...
          <div class="box-body">
            ...
            <div class="col col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name_person" id="name_person" onKeyUp="convertLowToUpper(name_person)" value="<?php echo htmlspecialchars( $responsable["name_person"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
              </div>
            </div>
