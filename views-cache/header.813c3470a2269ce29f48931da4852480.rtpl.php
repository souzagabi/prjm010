...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="/visitant?pg=1"><i class="fa fa-user"></i> <span>Controle Visitas</span></a></li>
      <li><a href="/residual?pg=1"><i class="fa fa-user"></i> <span>Controle Resíduos</span></a></li>
      <li <?php if( $_SESSION['User']["inadmin"] == 0 ){ ?> hidden<?php } ?>><a href="/material?pg=1"><i class="fa fa-user"></i> <span>Controle Materiais</span></a></li>
