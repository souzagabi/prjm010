...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php if( $_SESSION['User']["inadmin"] == 0 ){ ?> hidden<?php } ?> hidden><a href="<?php if( $_SESSION['User']["inadmin"] == 1 ){ ?>/nobreak?pg=1<?php } ?>"><i class="fa fa-bolt"></i> <span>Controle NoBreak</span></a></li>
      ...
      <li <?php if( $_SESSION['User']["inadmin"] == 0 ){ ?> hidden<?php } ?> hidden><a href="<?php if( $_SESSION['User']["inadmin"] == 1 ){ ?>/extintor?pg=1<?php } ?>"><i class="fa fa-fire-extinguisher"></i> <span>Controle Extintor</span></a></li>
