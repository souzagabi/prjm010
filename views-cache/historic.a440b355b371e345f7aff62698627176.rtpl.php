<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/purifier">Purificadores</a></li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col form-control top">
          <div class="row">
            <div class="col col-md-4">
              <form action="/historicP/create" method="get">
                <input type="submit" name="btnpurifier" class="btn btn-success" value="Cadastrar Histórico">
                <a href="/purifier?pg=1" class="btn btn-warning">Voltar</a>
