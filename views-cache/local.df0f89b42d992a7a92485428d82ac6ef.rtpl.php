<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="/local">Locais</a></li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div class="col form-control top">
          <div class="row">
            <div class="col col-md-4">
              <form action="/local/create" method="get">
                ...
                <input type="text" name="local" value="local" hidden>
              </form>
            </div>
          </div>
        </div>
      ...
      <div class="box box-primary" <?php if( !$locais ){ ?>hidden<?php } ?>>
          ...
          <table class="table table-straped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="/local/<?php echo htmlspecialchars( $value1["local_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                  <a href="/local/<?php echo htmlspecialchars( $value1["local_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
