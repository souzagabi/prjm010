                    ...
                    <form role="form" action="/location/<?php echo htmlspecialchars( $location["location_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
                        <div class="box-body">
                            <div class="col col-md-4">
                                ...
                                <label for="deslocation">Localização</label><strong class="obrigatorio"> *</strong>
                                <input type="text" class="form-control" name="deslocation" id="deslocation" value="<?php echo htmlspecialchars( $location["deslocation"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onkeyup="convertLowToUpper(deslocation)" autofocus="autofocus" required>
                                </div>
                            </div>
                        </div>
