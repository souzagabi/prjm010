          ...
          <div class="box-body">
            ...
            <div class="col col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="reason" id="reason" value="<?php echo htmlspecialchars( $visitant["reason"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
              </div>
            </div>
          ...
          <div class="box-body">
            ...
            <div class="col col-md-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="auth" id="auth" value="<?php echo htmlspecialchars( $visitant["auth"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
              </div>
            </div>
            <div class="col col-md-3">
              <div class="form-group">
                <label for="sign">Assinatura</label>
                <input type="text" class="form-control" name="sign" id="sign" value="<?php echo htmlspecialchars( $visitant["sign"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
              </div>
            </div>
            <div class="col col-md-2">
              <div class="form-group">
